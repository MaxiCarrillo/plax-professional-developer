...
VALUES
  (UUID_TO_BIN('8b07383c-cfbe-4dfe-b122-3ee0f5ac4230'), 'admin@gmail.com', 'admin', 'admin', '$2a$12$bf3ixm7VtrWDW4XzCkZTfO9znJT.CCa.NJDzpeiM.SflKMwq/5A8y', 'ADMIN'),
...
VALUES
  (50000, UUID_TO_BIN('8a9b6e3d-27b2-4a0d-9992-d35031e5c7a8'), UUID_TO_BIN('be39b7dd-fe38-44f4-8ada-451681d01c7f'), 'Av. Playa 123, Cancun', 'Hotel frente al mar, con todas las comodidades', 'Hotel Duna'),
  (35000, UUID_TO_BIN('a3b2e1f4-9e02-49ea-b0d1-b6f5d9536891'), UUID_TO_BIN('be39b7dd-fe38-44f4-8ada-451681d01c8f'), 'Calle del Sol 456, Buenos Aires', 'Departamento con vista panorámica', 'Departamento Sol'),
  (30000, UUID_TO_BIN('d5f8f0f4-ec7e-406d-8d96-5d5053b4f1f0'), UUID_TO_BIN('be39b7dd-fe38-44f4-8ada-451681d01c6f'), 'Calle Libertad 789, Mendoza', 'Casa amplia con jardín para familias', 'Casa Libertad'),
  (40000, UUID_TO_BIN('c3e2d8f5-2731-4e12-91d5-c8f5ff01392c'), UUID_TO_BIN('be39b7dd-fe38-44f4-8ada-451681d01c5f'), 'Calle del Lago 555, Rosario', 'Hotel boutique con encanto', 'Hotel Boutique Lago'),
  (25000, UUID_TO_BIN('f8a83214-182b-4204-b44a-31e82f9c5ca4'), UUID_TO_BIN('be39b7dd-fe38-44f4-8ada-451681d01c4f'), 'Ruta 40 Km 900, Neuquén', 'Cabaña en el campo, rodeada de naturaleza', 'Cabaña del Valle'),
